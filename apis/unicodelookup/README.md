...
[![NuGet](https://img.shields.io/nuget/v/APIVerve.API.UnicodeCharacterLookup.svg?style=flat&logo=nuget)](https://www.nuget.org/packages/APIVerve.API.UnicodeCharacterLookup)
...
```bash
curl -X GET "https://api.apiverve.com/v1/unicodelookup" \
  -H "x-api-key: YOUR_API_KEY"
```

[Get your API key →](https://dashboard.apiverve.com)

**[🧪 Live Test this API →](https://apiverve.com/marketplace/unicodelookup)**
...
- **[Live Test](https://apiverve.com/marketplace/unicodelookup)** - Test in your browser
- **[Try in Postman](https://www.postman.com/apiverve/apiverve-workspace/collection/a6utjd8/apiverve-api-collection)** - Import to Postman
- **[OpenAPI Spec](openapi.json)** - Full API specification
- **[Documentation](https://docs.apiverve.com/ref/unicodelookup)** - Full documentation
