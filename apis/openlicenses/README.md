...
[![NuGet](https://img.shields.io/nuget/v/APIVerve.API.OpenSourceLicenses.svg?style=flat&logo=nuget)](https://www.nuget.org/packages/APIVerve.API.OpenSourceLicenses)
...
```bash
curl -X GET "https://api.apiverve.com/v1/openlicenses" \
  -H "x-api-key: YOUR_API_KEY"
```

[Get your API key →](https://dashboard.apiverve.com)

**[🧪 Live Test this API →](https://apiverve.com/marketplace/openlicenses)**
...
- **[Live Test](https://apiverve.com/marketplace/openlicenses)** - Test in your browser
- **[Try in Postman](https://www.postman.com/apiverve/apiverve-workspace/collection/a6utjd8/apiverve-api-collection)** - Import to Postman
- **[OpenAPI Spec](openapi.json)** - Full API specification
- **[Documentation](https://docs.apiverve.com/ref/openlicenses)** - Full documentation
...
### NPM
```bash
npm install @apiverve/openlicenses
```

### PyPI
```bash
pip install apiverve-openlicenses
```
