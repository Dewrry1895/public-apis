...
[![NuGet](https://img.shields.io/nuget/v/APIVerve.API.UserAgentParser.svg?style=flat&logo=nuget)](https://www.nuget.org/packages/APIVerve.API.UserAgentParser)
...
**[🧪 Live Test this API →](https://apiverve.com/marketplace/useragentparser)**
...
- **[Live Test](https://apiverve.com/marketplace/useragentparser)** - Test in your browser
- **[Try in Postman](https://www.postman.com/apiverve/apiverve-workspace/collection/a6utjd8/apiverve-api-collection)** - Import to Postman
- **[OpenAPI Spec](openapi.json)** - Full API specification
- **[Documentation](https://docs.apiverve.com/ref/useragentparser)** - Full documentation
...
### NPM
```bash
npm install @apiverve/useragentparser
```
