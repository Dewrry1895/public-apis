...
[![NuGet](https://img.shields.io/nuget/v/APIVerve.API.CoordinatesAreSea.svg?style=flat&logo=nuget)](https://www.nuget.org/packages/APIVerve.API.CoordinatesAreSea)
...
```bash
curl -X GET "https://api.apiverve.com/v1/coordinatesaresea" \
  -H "x-api-key: YOUR_API_KEY"
```

[Get your API key →](https://dashboard.apiverve.com)

**[🧪 Live Test this API →](https://apiverve.com/marketplace/coordinatesaresea)**
...
- **[Live Test](https://apiverve.com/marketplace/coordinatesaresea)** - Test in your browser
- **[Try in Postman](https://www.postman.com/apiverve/apiverve-workspace/collection/a6utjd8/apiverve-api-collection)** - Import to Postman
- **[OpenAPI Spec](openapi.json)** - Full API specification
- **[Documentation](https://docs.apiverve.com/ref/coordinatesaresea)** - Full documentation
...
### NPM
```bash
npm install @apiverve/coordinatesaresea
```
